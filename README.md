...
Analyzed equine health data using exploratory data analysis and multiple linear regression to model respiratory rate; evaluated transformations, permutation-based inference, and heteroscedasticity-robust standard errors to assess predictor significance and model assumptions. (Team Project — SDS 4030: Statistics for Data Science II)
